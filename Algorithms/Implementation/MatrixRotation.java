...
public class MatrixRotation {
    ...
    public static void main(String[] args) {
        ...
        for(int k = 0;  ; k++){
            ...
            {
                temp1 = mn[i][j];
                for(i = tempi; i<m-1; i++ ){ //rotate south
                    temp2 = mn[i+1][j];
                    mn[i+1][j] = temp1;
                    temp1 = temp2;
                }
                ...
                i--;   
                for(j = tempj; j<n-1; j++ ){ // rotate right
                    temp2 = mn[i+1][j+1];
                    mn[i+1][j+1] = temp1;
                    temp1 = temp2;
                }
        ...
        for(int x = 0; x<mn.length; x++){
            for(int y = 0; y<mn[0].length; y++){
                if(y == mn[0].length-1){
                System.out.print(mn[x][y]);
                }else{
                 System.out.print(mn[x][y] + " ");   
                }
